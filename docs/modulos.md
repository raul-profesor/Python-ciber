...
Una de las ventajas de las funciones es cómo separan los bloques de código de su programa principal. Utilizando nombres descriptivos para las funciones, el
programa principal será mucho más fácil de seguir. 
...
Almacenar funciones en un archivo separado permite ocultar los detalles de del código del programa y centrarse en la lógica de alto nivel. También permite
reutilizar las funciones en muchos programas diferentes.
